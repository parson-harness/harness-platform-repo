...
variable "artifact_registry_type" {
  ...
  validation {
    ...
    error_message = "artifact_registry_type must remain 'har' for the ASG sandbox stack"
  }
}
...
variable "create_dockerhub_upstream" {
  ...
  validation {
    ...
    error_message = "create_dockerhub_upstream must remain true for the ASG sandbox stack"
  }
}
...
variable "use_harness_code" {
  ...
  validation {
    ...
    error_message = "use_harness_code must remain true for the ASG sandbox stack"
  }
}
