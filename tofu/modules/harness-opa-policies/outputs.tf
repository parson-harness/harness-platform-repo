...
output "change_governance_policy_ids" {
  ...
  value = {
    ...
    supply_chain_release_evidence = var.create_change_governance_policies ? harness_platform_policy.supply_chain_release_evidence[0].identifier : null
  }
}
...
output "policy_set_ids" {
  ...
  value = {
    ...
    supply_chain_release_guardrails = var.create_change_governance_policies && var.create_change_governance_policy_set ? harness_platform_policyset.supply_chain_release_on_step[0].identifier : null
  }
}
